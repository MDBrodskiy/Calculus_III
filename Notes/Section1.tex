...
\begin{itemize}
  ...
  \section{Lines, Planes, and Hyperplanes}
    ...
    \item Parametric Description of a Line
      ...
      \begin{itemize}
        ...
        \item  $\left\{\begin{array}{c} x(t)=x_o+ta\\y(t)=y_o+tb\end{array}$

        \item In $\mathbb{R}^3$: $\left\{\begin{array}{c} x(t)=x_o+ta\\y(t)=y_o+tb\\z(t) = z_o + tc\end{array}$
    ...
    \item Parametric Planes
      ...
      \begin{figure}[h!]
        \centering \include{Figures/Plane.tex}
        \caption{Parametrization of a Plane}
      \end{figure}

      \begin{figure}[h!]
        \centering \include{Figures/PlaneSpecific.tex}
  ...
  \item $f'(t)=\lim_{h\to 0}\left( \frac{f(t+h)-f(t)}{h} \right)$

  \item \textit{Ex.} $f(t)=\langle t^2, t^3 \rangle\Rightarrow f'(t)=\langle 2t, 3t^2 \rangle$
    ...
    \item \textit{Ex.} Given $\overline{p}(t) = \langle \cos(t), \sin(t), t \rangle$, find velocity and acceleration:
      ...
      \begin{itemize}
        ...
        \item Speed $= | \overline{v}(t)|$
          ...
          $$|\overline{v}(t)| = \sqrt{\left(-\sin(t)\right)^2 + \left( \cos(t) \right)^2 + 1 = \sqrt{2}$$
